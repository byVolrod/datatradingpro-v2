...
(function () {
  ...
  function declarer() {
    ...
    DTPWidgets.enregistrer({
      ...
      src: 'Contrats à terme COMEX et NYMEX (or, argent, cuivre, platine) via Yahoo Finance, clôtures quotidiennes sur un an alignées sur les séances communes ; ratios et rangs calculés par DTP.',
