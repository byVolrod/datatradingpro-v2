...
function buildCampaignIntro({ name, email, campaign } = {}) {
  ...
  const body = `
    ...
    <p style="margin:0 0 14px;">Merci de faire partie de l'aventure <strong style="color:#f3c344;">DataTradingPro</strong>. Vous recevrez plusieurs e-mails par semaine&nbsp;: des <strong style="color:#fff;">analyses macro&eacute;conomiques</strong>, des <strong style="color:#fff;">d&eacute;cryptages des &eacute;v&eacute;nements majeurs</strong>, des <strong style="color:#fff;">synth&egrave;ses de march&eacute;</strong> et des explications concr&egrave;tes pour mieux comprendre les mouvements des march&eacute;s financiers.</p>
    <p style="margin:0 0 14px;">L'objectif est simple&nbsp;: vous aider &agrave; <strong style="color:#fff;">interpr&eacute;ter l'actualit&eacute; macro&eacute;conomique</strong>, anticiper les r&eacute;actions des march&eacute;s et prendre des d&eacute;cisions de trading plus &eacute;clair&eacute;es gr&acirc;ce aux analyses de DataTradingPro. C'est <strong style="color:#f3c344;">100&nbsp;% gratuit</strong> et chaque e-mail est con&ccedil;u pour vous apporter un maximum de valeur.</p>
