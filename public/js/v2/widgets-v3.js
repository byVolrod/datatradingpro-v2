...
(function () {
  ...
  var CSS = ''
    + 'html.dtp-v2 .v3w{position:relative;display:flex;flex-direction:column;height:100%;min-height:0;background:#0a0a0c;color:#d6d6dc;font:500 11.5px/1.3 "Inter Tight",system-ui,sans-serif;font-variant-numeric:tabular-nums}'
    + 'html.dtp-v2 .v3w-tete{display:flex;align-items:center;gap:8px;flex-wrap:wrap;padding:7px 10px;border-bottom:1px solid #15151a}'
    + 'html.dtp-v2 .v3w-nom{font:600 12.5px/1 "Inter Tight",system-ui,sans-serif;color:#f2f2f4;margin-right:2px}'
    + 'html.dtp-v2 .v3w-prix{font:600 15px/1 "Inter Tight",system-ui,sans-serif;color:#f6f6f8}'
    + 'html.dtp-v2 .v3w-puce{display:inline-flex;align-items:center;gap:5px;height:20px;padding:0 7px;border:1px solid #22222a;border-radius:3px;background:#0f0f12;color:#a1a1aa;font-size:11px;white-space:nowrap}'
    + 'html.dtp-v2 .v3w-puce b{color:#f0f0f3;font-weight:600}'
    ...
    + 'html.dtp-v2 .v3w-live{margin-left:auto;display:inline-flex;align-items:center;gap:5px;color:#8e8e98;font-size:10.5px;letter-spacing:.04em}'
    ...
    + 'html.dtp-v2 .v3w-bulle{position:absolute;z-index:5;pointer-events:none;min-width:110px;padding:6px 8px;background:#111114;border:1px solid #2a2a31;border-radius:4px;box-shadow:0 12px 26px -12px rgba(0,0,0,.85);font-size:11px;line-height:1.45;color:#d6d6dc;opacity:0;transition:opacity .1s;white-space:nowrap}'
    + 'html.dtp-v2 .v3w-bulle b{color:#f4f4f6}'
    ...
    + 'html.dtp-v2 .v3w-rg>span:first-child{color:#8e8e98;font-weight:600}'
    + 'html.dtp-v2 .v3w-rg .v3w-l{color:' + ROUGE + ';text-align:right}html.dtp-v2 .v3w-rg .v3w-hh{color:' + VERT + '}'
    + 'html.dtp-v2 .v3w-rg em{font-style:normal;color:#8e8e98;text-align:right;font-size:10.5px;white-space:nowrap}'
    ...
    + 'html.dtp-v2 .v3w-sep{height:1px;background:#15151a;margin:2px 0}'
    + 'html.dtp-v2 .v3w-leg{display:flex;gap:10px;flex-wrap:wrap;padding:0 10px 6px;font-size:10.5px;color:#8e8e98}'
    ...
    + 'html.dtp-v2 .v3w-duo{flex:1;min-height:0;display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:1px;background:#15151a}'
    + 'html.dtp-v2 .v3w-duo>div{position:relative;background:#0a0a0c;display:flex;flex-direction:column;min-height:0}'
    + 'html.dtp-v2 .v3w-st{padding:6px 10px 0;font:600 10.5px/1 "Inter Tight",system-ui,sans-serif;color:#7c7c86}'
    + 'html.dtp-v2 .v3w-vide{margin:auto;color:#6f6f78;font-size:12px}'
  ...
  var CSS_H = ''
    + 'html.dtp-v2 .v3h{position:relative;display:flex;flex-direction:column;height:100%;min-height:0;background:#0a0a0c;color:#d6d6dc;font:500 11.5px/1.3 "Inter Tight",system-ui,sans-serif;font-variant-numeric:tabular-nums;padding:0 10px 8px}'
    + 'html.dtp-v2 .v3h-tete{display:flex;align-items:center;gap:8px;min-height:30px;border-bottom:1px solid #15151a;margin:0 -10px;padding:0 10px}'
    ...
    + 'html.dtp-v2 .v3h-axe span{position:absolute;bottom:3px;transform:translateX(-50%);font-size:10px;color:#6f6f78}'
    ...
    + 'html.dtp-v2 .v3h-nom b{display:flex;align-items:center;gap:6px;color:#8e8e98;font-weight:600;font-size:12px}'
    ...
    + 'html.dtp-v2 .v3h-ouvert .v3h-nom b{color:#f2f2f4}html.dtp-v2 .v3h-ouvert .v3h-nom b i{background:var(--ton);box-shadow:0 0 0 3px color-mix(in srgb,var(--ton) 25%,transparent)}'
    + 'html.dtp-v2 .v3h-piste{grid-column:2;position:relative;margin:5px 0;border-radius:4px;background:#0f0f12;box-shadow:inset 0 0 0 1px #17171c}'
    + 'html.dtp-v2 .v3h-bloc{position:absolute;top:0;bottom:0;border-radius:4px;background:color-mix(in srgb,var(--ton) 30%,#0f0f12);box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--ton) 55%,transparent);display:flex;align-items:center;justify-content:center;overflow:hidden;cursor:default}'
    + 'html.dtp-v2 .v3h-bloc b{position:relative;z-index:1;font-weight:600;font-size:11px;color:color-mix(in srgb,var(--ton) 35%,#f4f4f6);white-space:nowrap;padding:0 6px}'
    + 'html.dtp-v2 .v3h-ouvert .v3h-bloc{background:color-mix(in srgb,var(--ton) 34%,#0f0f12);box-shadow:inset 0 0 0 1px var(--ton),0 0 14px -4px var(--ton)}'
    ...
    + 'html.dtp-v2 .v3h-bientot .v3h-pil{border-color:rgba(227,178,58,.6);color:#e3b23a;background:rgba(227,178,58,.08)}'
    + 'html.dtp-v2 .v3h-cote em{font-style:normal;font-size:10.5px;color:#6f6f78;white-space:nowrap}'
    ...
    + 'html.dtp-v2 .v3h-bulle{position:absolute;z-index:5;pointer-events:none;padding:6px 8px;background:#111114;border:1px solid #2a2a31;border-radius:4px;box-shadow:0 12px 26px -12px rgba(0,0,0,.85);font-size:11px;line-height:1.45;opacity:0;transition:opacity .1s;white-space:nowrap}'
    + 'html.dtp-v2 .v3h-bulle b{color:#f4f4f6}'
