...
/* ═══ MISE A JOUR PERIODIQUE D'UNE CARTE (21/08) ═══════════════════════════════════════════════
  ...
  var WPREV = {
    ...
    /* SCENARIO DESK (09/09, demande de l'utilisateur : « mets un aperçu widget de Scenario Desk »).
       La vignette dit ce que la carte fait de PARTICULIER, pas ce qu'elle a en commun avec le
       calendrier : une échéance, et les DEUX seuils qui l'encadrent — au-dessus la devise se
       renforce (vert), en dessous elle s'affaiblit (rouge), le consensus au milieu en or. C'est la
       lecture entière du widget en un coup d'œil, et aucune autre carte du catalogue ne la produit. */
    'scenario-desk': '<svg ' + _PV + '><g font-family="monospace" font-size="6" fill="#9aa1ac">'
      + '<text x="6" y="12">USD</text><text x="24" y="12">IPC</text><text x="92" y="12">14:30</text></g>'
      + '<rect x="6" y="18" width="108" height="10" rx="2" fill="#0f2f22"/><rect x="6" y="18" width="40" height="10" rx="2" fill="#047857"/>'
      + '<text x="50" y="26" font-family="monospace" font-size="6" fill="#00e676">&#8805; 3,2</text>'
      + '<rect x="6" y="31" width="108" height="4" rx="1" fill="#1c1c20"/><rect x="52" y="30" width="3" height="6" rx="1" fill="#e3b23a"/>'
      + '<text x="60" y="36" font-family="monospace" font-size="5.5" fill="#e3b23a">cons. 3,1</text>'
      + '<rect x="6" y="39" width="108" height="10" rx="2" fill="#2c1113"/><rect x="6" y="39" width="40" height="10" rx="2" fill="#991b1b"/>'
      + '<text x="50" y="47" font-family="monospace" font-size="6" fill="#ff3d00">&#8804; 3,0</text></svg>',
    ...
    'kelly': '<svg ' + _PV + '><g font-family="monospace" font-size="5.5" fill="#6f6f79">'
      ...
      + '<rect x="74" y="15" width="26" height="34" rx="2" fill="#1c1c20"/><rect x="74" y="38" width="26" height="11" rx="2" fill="#8a6d20"/>'
      + '<text x="104" y="30" font-family="monospace" font-size="6" fill="#00e676">R</text>'
      + '<path d="M104 34 L110 34 M107 34 L107 44" stroke="#00e676" stroke-width="1.2" fill="none"/></svg>',
