...
(function () {
  ...
  var CSS = ''
    + 'html.dtp-v2 .v3n{display:flex;flex-direction:column;height:100%;min-height:0;background:#0a0a0c;color:#d6d6dc;font:500 12px/1.35 "Inter Tight",system-ui,sans-serif;font-variant-numeric:tabular-nums}'
    ...
    + 'html.dtp-v2 .v3n-titre{min-width:0}html.dtp-v2 .v3n-titre b{display:block;color:#f4f4f6;font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    + 'html.dtp-v2 .v3n-titre span{display:block;color:#6f6f78;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    ...
    + 'html.dtp-v2 .v3n-cmd button:hover{color:#f4f4f6;background:#16161b}'
    ...
    + 'html.dtp-v2 .v3n-vol{display:flex;align-items:center;justify-content:flex-end;gap:7px;color:#8e8e98;min-width:0}'
    ...
    + 'html.dtp-v2 .v3n-onde{position:relative;height:44px;margin:0 12px;border-radius:4px;background:#0e0e11;box-shadow:inset 0 0 0 1px #16161b;overflow:hidden}'
    ...
    + 'html.dtp-v2 .v3n-temps{position:absolute;right:8px;top:5px;font-size:10.5px;color:#8e8e98}'
    + 'html.dtp-v2 .v3n-casque{position:absolute;left:8px;top:5px;display:flex;align-items:center;gap:4px;font-size:10.5px;color:#6f6f78}'
    + 'html.dtp-v2 .v3n-filtres{display:flex;align-items:center;gap:4px;padding:10px 12px 6px;border-bottom:1px solid #15151a}'
    + 'html.dtp-v2 .v3n-nb{color:#6f6f78;font-size:11px;margin-right:auto;white-space:nowrap}'
    + 'html.dtp-v2 .v3n-puce{border:0;background:none;color:#8e8e98;font:600 10.5px/1 "Inter Tight",system-ui,sans-serif;letter-spacing:.06em;text-transform:uppercase;padding:5px 7px;border-radius:3px;cursor:pointer}'
    + 'html.dtp-v2 .v3n-puce:hover{color:#f4f4f6}html.dtp-v2 .v3n-puce.est-actif{color:#f4f4f6;background:#16161b;box-shadow:inset 0 -2px 0 ' + OR + '}'
    ...
    + 'html.dtp-v2 .v3n-ligne:hover{background:#101013}'
    + 'html.dtp-v2 .v3n-ligne b{display:block;color:#ececf0;font-weight:600;font-size:12.5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    + 'html.dtp-v2 .v3n-ligne span{display:block;color:#6f6f78;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    + 'html.dtp-v2 .v3n-ligne em{font-style:normal;color:#8e8e98;font-size:11.5px}'
