...
(function () {
  ...
  var T = {
    ...
    // Hero
    "Terminal de trading forex & macro · en français": "Forex & macro trading terminal · in French",
    ...
    // Alertes (25/09)
    "Alertes": "Alerts",
    "Le marché vous prévient.": "The market warns you.",
    "Même écran verrouillé.": "Even on your lock screen.",
    "Une annonce urgente, un chiffre du calendrier qui tombe, une nouvelle note de banque, un récap d’analyste : DataTradingPro vous alerte sur votre téléphone et votre ordinateur, comme une application.": "Breaking news, a calendar release, a new bank note, an analyst recap: DataTradingPro alerts you on your phone and your computer, like an app.",
    "iPhone et Android": "iPhone and Android",
    ", navigateur fermé et écran verrouillé compris.": ", even with the browser closed and the screen locked.",
    "Vous choisissez": "You choose",
    "les catégories : actualité, calendrier, analystes, institutions.": "the categories: news, calendar, analysts, institutions.",
    "Jamais submergé": "Never flooded",
    ": le nombre d’alertes par heure est plafonné.": ": alerts per hour are capped.",
    "Jeudi 25 septembre": "Thursday 25 September",
    "maintenant": "now",
    "il y a 2 min": "2 min ago",
    "il y a 18 min": "18 min ago",
    "il y a 1 h": "1 h ago",
    "L’Iran menace de fermer le détroit d’Ormuz après de nouvelles sanctions": "Iran threatens to close the Strait of Hormuz after new sanctions",
    "Calendrier · USD CPI m/m": "Calendar · USD CPI m/m",
    "Publié : 0,4% · prévision 0,3% · précédent 0,2%": "Actual: 0.4% · forecast 0.3% · previous 0.2%",
    "Global Markets Daily : le dollar reprend la main": "Global Markets Daily: the dollar takes back control",
    "Analystes · récap de séance": "Analysts · session recap",
    "Wall Street termine en hausse, le yen recule": "Wall Street closes higher, the yen slips",
    "Exemples de mise en forme": "Formatting examples",
    // La promesse
    ...
    // FAQ
    "Combien coûte DataTradingPro ?": "How much does DataTradingPro cost?",
    "24,99 € par mois, ou 239,99 € par an avec deux mois offerts. Sans engagement, résiliable en un clic, sans frais cachés.": "€24.99 per month, or €239.99 per year with two months free. No commitment, cancel in one click, no hidden fees.",
    "Quel est le meilleur terminal de trading en français ?": "What is the best trading terminal in French?",
    "DataTradingPro est un terminal de trading forex & macro 100% en français : il agrège et priorise en temps réel les actualités, le calendrier économique, la force des devises, le Smart Bias, les banques centrales et les taux, avec une couche d'analyse IA. Pensé pour les traders francophones, il rend le marché lisible depuis un seul écran, sur le web comme en application de bureau (Windows et macOS).": "DataTradingPro is a forex & macro trading terminal, 100% in French: it aggregates and prioritises news, the economic calendar, currency strength, Smart Bias, central banks and rates in real time, with a layer of AI analysis. Built for French-speaking traders, it makes the market readable from a single screen, on the web and as a desktop app (Windows and macOS).",
    "DataTradingPro est-il une alternative française à un terminal de marché professionnel ?": "Is DataTradingPro a French alternative to a professional market terminal?",
    "Oui. Vous retrouvez l'esprit d'une salle de marché — données macro et forex agrégées et priorisées, analyses IA — entièrement en français et à un tarif accessible, là où les terminaux institutionnels restent en anglais et bien plus chers.": "Yes. You get the feel of a trading floor — aggregated, prioritised macro and forex data, AI analysis — entirely in French and at an accessible price, where institutional terminals remain in English and far more expensive.",
    ...
    "Taux directeurs et probabilités": "Policy rates and probabilities",
    "Qui sommes-nous": "About us",
    "Une équipe de traders et de développeurs.": "A team of traders and developers.",
    "DataTradingPro est conçu et maintenu par une équipe qui réunit des traders et des développeurs. Les uns décident de ce qui compte au moment d'une annonce ; les autres le rendent lisible, en temps réel, sur un seul écran.": "DataTradingPro is built and maintained by a team of traders and developers. The former decide what matters when a release hits; the latter make it readable, in real time, on a single screen.",
    "Des traders": "Traders",
    "Ils choisissent ce qui mérite votre attention : les chiffres, les banques centrales, la réaction du marché.": "They choose what deserves your attention: the data, the central banks, the market reaction.",
    "Des développeurs": "Developers",
    "Ils rendent l'information fiable et lisible, du flux brut jusqu'à l'écran, sans rien inventer.": "They make the information reliable and readable, from the raw feed to the screen, without inventing anything.",
    "Vos retours": "Your feedback",
    "Chaque demande des abonnés est lue, et chaque nouveauté est annoncée dans le terminal lui-même.": "Every subscriber request is read, and every new feature is announced inside the terminal itself.",
    "Le taux de chaque grande banque centrale, sa prochaine réunion, et la probabilité de hausse, de statu quo ou de baisse que le marché lui attribue, lue sur les contrats à terme de taux quand ils existent.": "Each major central bank's rate, its next meeting, and the probability of a hike, hold or cut the market assigns to it, read from rate futures where they exist.",
    "Banques": "Banks",
    ...
    "Vos trades consignés sur plusieurs comptes (compte personnel, challenge de prop firm), avec statistiques, courbe de performance et tableau de bord, importables depuis Notion ou un CSV.": "Your trades logged across several accounts (personal account, prop firm challenge), with statistics, equity curve and dashboard, importable from Notion or a CSV.",
    "Taille de position et Kelly": "Position size and Kelly",
    "La taille de lot à prendre pour le risque que vous acceptez, et le critère de Kelly pour dimensionner selon vos propres statistiques, sans rien calculer de tête.": "The lot size to take for the risk you accept, and the Kelly criterion to size from your own statistics, with no mental arithmetic.",
