...
(function () {
  ...
  var CSS = ''
    ...
    + 'html.dtp-v2 .v3c-sep{width:1px;height:18px;background:var(--v3-bord, #22222a);margin:0 2px}'
    + 'html.dtp-v2 .v3c-sel{background:var(--v3-tete, #0e0e11);border:1px solid var(--v3-bord, #24242a);color:var(--v3-texte, #d6d6dc);font:500 11.5px "Inter Tight",system-ui,sans-serif;border-radius:4px;padding:4px 6px}'
    + 'html.dtp-v2 .v3c-corps{flex:1;min-height:0;display:flex}'
    + 'html.dtp-v2 .v3c-vue{position:relative;flex:1;min-width:0;overflow:hidden;cursor:grab;background:radial-gradient(120% 100% at 50% 40%,#0d0f14,var(--v3-fond, #08080a) 70%)}'
    ...
    + 'html.dtp-v2 .v3c-zoom{position:absolute;right:8px;bottom:8px;display:flex;flex-direction:column;gap:1px;background:var(--v3-ligne, #16161a);border:1px solid var(--v3-bord, #22222a);border-radius:4px;overflow:hidden}'
    + 'html.dtp-v2 .v3c-zoom button{width:26px;height:24px;border:0;background:var(--v3-tete, #0e0e11);color:#a1a1aa;font:600 14px/1 system-ui;cursor:pointer}'
    + 'html.dtp-v2 .v3c-zoom button:hover{color:var(--v3-or-texte, #e3b23a)}'
    + 'html.dtp-v2 .v3c-leg{position:absolute;left:8px;bottom:8px;display:flex;flex-wrap:wrap;gap:4px 10px;max-width:70%;padding:6px 8px;background:rgba(10,10,12,.82);border:1px solid var(--v3-trait, #1c1c21);border-radius:4px;font-size:11px;color:#a1a1aa;backdrop-filter:blur(6px)}'
    + 'html.dtp-v2 .v3c-leg i{display:inline-block;width:8px;height:8px;border-radius:50%;margin-right:5px;vertical-align:0}'
    + 'html.dtp-v2 .v3c-leg b{color:var(--v3-titre, #ececf0);font-weight:600;margin-left:3px}'
    + 'html.dtp-v2 .v3c-chaudes{flex:1 1 100%;display:flex;flex-wrap:wrap;align-items:center;gap:4px;padding-bottom:5px;margin-bottom:1px;border-bottom:1px solid var(--v3-trait, #1c1c21)}'
    + 'html.dtp-v2 .v3c-chaudes>span{color:var(--v3-or-texte, #e3b23a);font-weight:600;margin-right:2px}'
    + 'html.dtp-v2 .v3c-chaudes button{border:1px solid var(--v3-bord, #26262c);background:var(--v3-tete, #101013);color:var(--v3-texte, #d6d6dc);font:500 11px/1 "Inter Tight",system-ui,sans-serif;padding:3px 7px;border-radius:3px;cursor:pointer;transition:border-color .15s,color .15s}'
    + 'html.dtp-v2 .v3c-chaudes button:hover{border-color:rgba(227,178,58,.6);color:var(--v3-titre, #f4f4f6)}'
    + 'html.dtp-v2 .v3c-bulle{position:absolute;pointer-events:none;z-index:4;min-width:140px;max-width:260px;padding:7px 9px;background:var(--v3-tete, #101013);border:1px solid var(--v3-bord, #2a2a31);border-radius:4px;box-shadow:0 14px 30px -12px rgba(0,0,0,.8);font-size:11.5px;line-height:1.4;color:var(--v3-texte, #d6d6dc);opacity:0;transition:opacity .12s}'
    + 'html.dtp-v2 .v3c-bulle b{color:var(--v3-titre, #f4f4f6)}'
    + 'html.dtp-v2 .v3c-fiche{width:300px;flex:0 0 300px;border-left:1px solid var(--v3-ligne, #16161a);background:var(--v3-carte, #0b0b0d);overflow-y:auto;display:none}'
    ...
    + 'html.dtp-v2 .v3c-fh{display:flex;align-items:center;gap:8px;padding:10px 12px;border-bottom:1px solid var(--v3-ligne, #16161a)}'
    + 'html.dtp-v2 .v3c-fh h4{flex:1;margin:0;font:600 14px/1.2 "Inter Tight",system-ui,sans-serif;color:var(--v3-titre, #f4f4f6)}'
    + 'html.dtp-v2 .v3c-fh button{border:0;background:none;color:var(--v3-pale, #6f6f78);font-size:17px;cursor:pointer}'
    + 'html.dtp-v2 .v3c-fl{width:18px;height:18px;border-radius:50%;object-fit:cover;box-shadow:0 0 0 1px #26262c}'
    + 'html.dtp-v2 .v3c-sec{padding:10px 12px;border-bottom:1px solid var(--v3-ligne, #141417)}'
    + 'html.dtp-v2 .v3c-sec h5{margin:0 0 7px;font:600 11.5px/1 "Inter Tight",system-ui,sans-serif;color:var(--v3-doux, #7c7c86)}'
    + 'html.dtp-v2 .v3c-kv{display:flex;justify-content:space-between;gap:8px;font-size:12px;padding:3px 0;color:#b9b9c2}'
    + 'html.dtp-v2 .v3c-kv b{color:var(--v3-titre, #f0f0f3);font-weight:600;font-variant-numeric:tabular-nums}'
    ...
    + 'html.dtp-v2 .v3c-chaine span{padding:3px 6px;border:1px solid var(--v3-bord, #24242a);border-radius:3px;background:var(--v3-tete, #101013);color:var(--v3-texte, #d6d6dc)}'
    + 'html.dtp-v2 .v3c-chaine em{font-style:normal;color:var(--v3-or-texte, #e3b23a)}'
    + 'html.dtp-v2 .v3c-dep{display:flex;gap:8px;padding:6px 0;border-top:1px solid var(--v3-ligne, #141417);font-size:12px;line-height:1.4;color:#c9ccd4}'
    + 'html.dtp-v2 .v3c-dep:first-of-type{border-top:0}'
    + 'html.dtp-v2 .v3c-dep time{flex:0 0 36px;color:var(--v3-pale, #6f6f78);font-variant-numeric:tabular-nums}'
    + 'html.dtp-v2 .v3c-dep i{flex:0 0 6px;height:6px;border-radius:50%;margin-top:6px}'
    + 'html.dtp-v2 .v3c-vide{color:var(--v3-pale, #6f6f78);font-size:12px}'
    + 'html.dtp-v2 .v3c-attente{position:absolute;inset:0;display:grid;place-items:center;color:var(--v3-pale, #6f6f78);font-size:12px}'
    + '@media (max-width:720px){html.dtp-v2 .v3c-corps{flex-direction:column}html.dtp-v2 .v3c-fiche{width:auto;flex:0 0 46%;border-left:0;border-top:1px solid var(--v3-ligne, #16161a)}}'
