...
(function () {
  ...
  var CSS = ''
    + 'html.dtp-v2 .v3m{display:flex;flex-direction:column;height:100%;min-height:0;background:#0a0a0c;font-family:"Inter Tight",system-ui,sans-serif}'
    + 'html.dtp-v2 .v3m-bar{display:flex;gap:4px;flex-wrap:wrap;padding:6px 8px;border-bottom:1px solid #16161a;background:#0c0c0e}'
    + 'html.dtp-v2 .v3m-ch{border:1px solid #24242a;background:transparent;color:#8e8e98;font:500 11.5px/1 "Inter Tight",system-ui,sans-serif;padding:5px 9px;border-radius:4px;cursor:pointer}'
    + 'html.dtp-v2 .v3m-ch:hover{color:#ececf0}html.dtp-v2 .v3m-ch.on{color:#e3b23a;border-color:rgba(227,178,58,.55);background:rgba(227,178,58,.08)}'
    + 'html.dtp-v2 .v3m-liste{flex:1;min-height:0;overflow-y:auto}'
    + 'html.dtp-v2 .v3m-cl{position:sticky;top:0;z-index:1;padding:5px 10px;background:#0e0e11;border-bottom:1px solid #16161a;font:600 11.5px/1.2 "Inter Tight",system-ui,sans-serif;color:#7c7c86}'
    + 'html.dtp-v2 .v3m-l{display:grid;grid-template-columns:minmax(92px,1.3fr) 92px minmax(70px,1fr) 70px minmax(64px,.9fr);align-items:center;gap:10px;padding:6px 10px;border-bottom:1px solid #121215;transition:background .12s}'
    + 'html.dtp-v2 .v3m-l:hover{background:rgba(227,178,58,.04)}'
    + 'html.dtp-v2 .v3m-n{min-width:0}html.dtp-v2 .v3m-n b{display:block;font:600 12.5px/1.2 "Inter Tight",system-ui,sans-serif;color:#f0f0f3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
    + 'html.dtp-v2 .v3m-n span{font:500 10.5px/1.2 ui-monospace,Menlo,monospace;color:#6f6f78}'
    + 'html.dtp-v2 .v3m-sp{width:92px;height:24px;display:block}'
    + 'html.dtp-v2 .v3m-p{text-align:right;font:600 12.5px/1 ui-monospace,Menlo,monospace;color:#ececf0;font-variant-numeric:tabular-nums}'
    + 'html.dtp-v2 .v3m-c{text-align:right;font:600 12px/1 ui-monospace,Menlo,monospace;font-variant-numeric:tabular-nums}'
    + 'html.dtp-v2 .v3m-up{color:#00e676}html.dtp-v2 .v3m-dn{color:#ff3d00}html.dtp-v2 .v3m-eq{color:#8e8e98}'
    + 'html.dtp-v2 .v3m-rg{position:relative;height:4px;border-radius:2px;background:#1c1c21}'
    ...
    + 'html.dtp-v2 .v3m-ko{grid-column:2/-1;color:#6f6f78;font-size:11.5px}'
    + 'html.dtp-v2 .v3m-pied{padding:5px 10px;border-top:1px solid #16161a;font-size:10.5px;color:#6f6f78;background:#0c0c0e}'
    + 'html.dtp-v2 .v3m-vide{padding:24px;text-align:center;color:#6f6f78;font-size:12px}'
